 ...
 * 
 *          CLASS STATIC OBJECTS These are objects that only provide a
 *          description. They may be neutral objects or objects that provide
 *          clues. (Some of these objects are things that are taken from the
 *          room and placed into the inventory. NOT IMPLEMENTED)
 */
public class StaticObjects extends Inventory {
	/*
	 * CLASS STATIC OBJECTS These are objects that only provide a description. They
	 * may be neutral objects or objects that provide clues. (Some of these objects
	 * are things that are taken from the room and placed into the inventory. NOT
	 * IMPLEMENTED)
	 */
	...
	public void aPaper() {
		...
		System.out.println(
				"On it, there writes: '--two, tie your shoe.'. There is a drawing of a green shoe right beneath it.");
	}
	...
	public void aShelf() {
		...
		System.out.println(
				"There is a red Bird, a yellow Bird, and a green Bird.\nTo view type:\n'r'-red Bird\n'y'-yellow Bird\n'g'-greenbird");
	...
	public void aPuddle() { // Added by Haine
		System.out.println(
				"Upon closer inspection, it's not much of a puddle. It just looks like someone dropped\nice cubes where you're standing, and it melted.\n");
	}

	public void aBlackboard() {
		System.out.println(
				"It is a regular blackboard, about as big as the ones in classrooms.\nIt's covered in chalk profanities. Write on it? 'y'/'n'");
	}
