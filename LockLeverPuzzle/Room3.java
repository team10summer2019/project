 ...
 *
 *          CLASS ROOM3 Runs Room specific configurations
 *
 */
...
////////////////////////ITEM METHODS////////////////////////////////
	...
	////////// CABINET/////////
	/**
	 * Provide information and interactions with object in room If user has key,
	 * cabinet can be opened and viewed, otherwise it doesn't do anything The
	 * cabinet initially contains box and leverPiece2
	 */
	public void viewCabinet() {
		...
		while (awaitInput == true) {
			...
			if (playerInventory.hasItemInInventory(dyn_item.cabinetKey) == true) {
				...
				// if lever does not exist in
				// inventory///////////////////////////////////////////
				if (playerInventory.hasItemInInventory(dyn_item.leverP2) == false) {
					while (awaitInput1 == true) {
						System.out.println(
								"There is a green box in the cabinet as well as a metal object..is it a broken lever?");
	...
	////////// VIEW UNDER CABINET/////////
	/*
	 * Provide information and interactions with object in room opens views yellow
	 * box, inside a bracelet and key
	 */
