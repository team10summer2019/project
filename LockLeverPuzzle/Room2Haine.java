 ...
 *
 *          CLASS ROOM2HAINE Runs Room specific configurations
 *
 */
...
public class Room2Haine extends GenericRoom {
	...
	/*
	 * public boolean gameMenuOne() { gameRunning = true; inRoom2 = true; while
	 * (gameRunning == true) { //////////GAME MENU System.out.
	 * println("\nYou decide to take a look around the room. Some things stand out to you."
	 * ); this.gotBearLever1 = room1(); } return this.gotBearLever1; }
	 * 
	 * public boolean gameMenuTwo() { gameRunning = true; inRoom2 = true; while
	 * (gameRunning == true) { //////////GAME MENU System.out.
	 ...
	 * ); this.gotBearLever2 = room2(); } return this.gotBearLever2; }
	 */
//////////CONSTRUCTORS////////////
	/**
...
//////////SET INROOM2H////////////
	/**
	 * @param inRoom_Bool Status of being in Room; true if in Room, false if not in
	 *                    Room
	 */
...
//////////ORANGEBOX////////////
	...
	public void viewToyBox() {
		...
		while (awaitInput == true) {
			...
			if (userInput.equalsIgnoreCase("y")) {
				System.out.println(
						"Is this someone's toy chest? It's full of children's knick knacks. One of them, a stuffed owl with comically large eyes looks back at you.");
				System.out.println(
				...
				/*
				 * if (gotBearLever2 == false) { dyn_item.itemInfo_dynObj(dyn_item.leverP2);
				 * uniqueObject_toInventory(dyn_item.leverP2); this.gotBearLever2 = true; }
				 */
				awaitInput = false;
			} else if (userInput.equalsIgnoreCase("n")) {
				System.out.println("you decided not to open the box.\n");
