 ...
 * 
 *          CLASS GENERIC ROOM (Renamed and modified from old Start Class) This
 *          is a Room superclass which contain generic room properties as well
 *          as instances of Classes that will be passed into the Room
 *          subclasses.
 */
...
//////////GAME MENU////////////
	/**
	 * GAME MENU Calls for particular Room to initiate
	 */
...
//////////////////////////////////////////////////////////////////
	...
	// ROOM 1 HAINE
	/**
	 * Prompts user to decide to view the room or not and then calls for Room1Haine
	 * Class.
	 */
	...
	// ROOM 2 HAINE
	/**
	 * Prompts user to decide to view the room or not and then calls for Room2Haine
	 * Class and method
	 */
	...
	// ROOM 3
	/**
	 * Prompts user to decide to view the room or not and then calls for Room3 Class
	 * and method
	 */
	...
	// ROOM 4
	/**
	 * Prompts user to decide to view the room or not and then calls for Room4 Class
	 * and method
	 */
...
//////////EXIT VIEW////////////
	 ...
	 * @param roomName  name checks and calls for proper method to exit the current
	 *                  room specified
	 */
	private void exitView(String userInput, String roomName) {
		if (userInput.equalsIgnoreCase("exit")) { // don't need to prompt for each item(aka. make a new method to call
													// it) because it'll be combined later on
...
//////////SET GAMERUNNING////////////
	/**
	 * @param status If game is running, status is true. Game stops running and
	 *               exits loop if status is false.
	 */
...
//////////Add Unique Object to Inventory////////////
	/**
	 * Changes the status of any DynamicObjects item. Adds the unique item to
	 * Inventory and removes unique item from FloorInventory by its string 'identity
	 * name'
	 * 
