 ...
 *
 *          CLASS ROOM1HAINE Runs Room specific configurations
 *
 */
...
//////////ROOM 1 HAINE////////////
	...
	public void room1H() {
		while (inRoom1H == true) {
			...
			System.out.println(
					"In the centre of the room, you can see a teddy bear on the floor, holding something. There is a blackboard on one wall. Next to that wall, there is a shelf with three photos displayed.");
...
//////////BEAR////////////
	...
	public void viewBear() {
		...
		while (awaitInput == true) {
			...
			// RECOMMENDED TO USE THIS FOR REFERENCE:FOR ENCOUNTERING DYNAMIC OBJECTS THAT
			// WILL BE PICKED UP)
