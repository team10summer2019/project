 ...
 * 
 *          CLASS DYNAMIC OBJECTS These are objects that behave as Keys(usually
 *          a boolean for access). These objects are things that are taken from
 *          the room and placed into the inventory.
 */
public class DynamicObjects extends StaticObjects {
	 ...
	 * 
	 * @param item The item that has been called by a Room Class/looked at or taken
	 *             into Inventory Class in the game
	 */
	...
	/**
	 * Changes the status of the dynamic item in LockLever for pieces 'leverPiece1'
	 * and 'leverPiece2'.
	 * 
	 * @param item The item that has been called by a Room Class/looked at or taken
	 *             into Inventory Class in the game.
	...
	private String string_leverP1() {
		System.out.println(
				"It is a metal rod with an end that has grooves on it like a screw. The other end looks like it should attach to a hinge mechanism.");
		return "leverPiece1";
	}

	/**
	 * Calls to an instance of LockLever class to change the status of the object
	 * existing in Inventory Class.
	 */
	...
	private String string_leverP2() {
		System.out.println(
				"It is a metal rod that is hollow on one end and a red round knob. It almost looks like a toy lollipop. There are grooves inside the hollow end of the rod.");
		return "leverPiece2";
	}
