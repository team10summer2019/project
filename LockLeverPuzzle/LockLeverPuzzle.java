 ...
 * 
 *          CLASS LOCK LEVER PUZZLE lock lever puzzle has the same traits as
 *          GenericComboLock an additional lever key is set to act as a key
 *          puzzle will unlock both combination and lever are put in the right
 *          position subclass of GenericComboLock
 * 
 */
public class LockLeverPuzzle extends GenericComboLock {
	/*
	 * CLASS LOCK LEVER PUZZLE lock lever puzzle has the same traits as
	 * GenericComboLock an additional lever key is set to act as a key puzzle will
	 * unlock both combination and lever are put in the right position subclass of
	 * GenericComboLock
	 */
	...
	public void information() {
		...
		System.out.print(
				"This contraption..this looks like a combination lock. Theres three gears, each with a shape drawn right underneath it.\nThere's a hole on the side of the contraption.");
		super.checkCombo();
	}
	...
	/**
	 * If lever is positioned away from you, it is in the correct position to be
	 * unlocked
	 */
	public void shiftLever() {// forwards,backwards,neutral
		if (lever_canUse == true) {
			...
			System.out.println(
					"The hole on the side of the contraption must do something. Maybe something can help activate it.");
		}
	}
