...
///////////////////////////////////////////////////////////////////////////////////////
	...
	// Main loop to run the Maze Game 
		...
		while ( moveCounter < 300 && !storeInput.equalsIgnoreCase("quit")  && gameBoard.getHero().isAlive()  ){
			...
			if ( storeInput.equalsIgnoreCase("Look")){
			...
			// keys for picking up wolf, cabbage, goat
	...
	public static void setBoard( Maze m){
		...
		//setRoomItems(int x , int y,  boolean key, boolean door ,boolean map, boolean monster, boolean riddle, boolean hint, boolean comboLock ){ 
		//ROW 0
		...
		m.setRoomItems(1,0,false,true,false,false,false,false,false,false,false,false); // has door
		// room (2,0)
		m.setRoomWalls(2,0,false,false,true,true);
		// room (0,3)
		m.setRoomWalls(3,0,true,true,true,false);
		m.setRoomItems(3,0,false,false,false,false,false,false,true,false,false,false); // has hint
		// room (1,0)
		m.setRoomWalls(0,1,true,true,false,false);
		m.setRoomItems(0,1,false,false,false,false,false,true,false,false,false,false); // has hint
		// room (1,1)
		m.setRoomWalls(1,1,true,false,true,false); 
		// room (2,1)
		m.setRoomWalls(2,1,false,false,true,true);
		m.setRoomItems(2,1,false,false,false,false,false,true,false,false,false,false); // has hint
		// room (3,1)
		m.setRoomWalls(3,1,false,true,false,false);
		// room (0,2)
		m.setRoomWalls(0,2,true,true,false,true);		//right wall blocked until riddle solved
		m.setRoomItems(0,2,false,false,false,false,true,false,false,false,false,false); // has riddle
		// room (1,2)
		m.setRoomWalls(1,2,false,true,false,false);
		// room (2,2)
		m.setRoomWalls(2,2,true,true,true,false);
		m.setRoomItems(2,2,true,false,false,false,false,false,false,false,false,false); // has key
		// room (3,2)
		m.setRoomWalls(3,2,true,true,false, false);
		// room (0,3)
		m.setRoomWalls(0,3,true,false,true,true);
		m.setRoomItems(0,3,false,false,true,false,false,false,false,false,false,false); // has map
		// room (1,3)
		m.setRoomWalls(1,3,false,true,false,true);
		// room (3,2)
		m.setRoomWalls(2,3,true,false,true,true);		//up wall blocked until riddle solved
		m.setRoomItems(2,3,false,false,false,false,true,false,false,false,false,false); // has riddle
		// room (3,3)
		...
		/////////////////// MAZE IS HAND DESIGNED ////////////////////////////
		// setRoomWalls(int x,int y, boolean left, boolean right, boolean up, boolean down){
		//setRoomItems(int x , int y,  boolean key, boolean door ,boolean map, boolean monster, boolean riddle, boolean hint, boolean comboLock, boolean wolf, boolean cabbage, boolean goat ){ 
		//ROW 0
		m.setRoomWalls(0,0,true,true,true,false); // setup the first room 
		m.setRoomPlayer(0,0,true);  // place the player in the first room
		m.setRoomWalls(1,0,true,false,true,false);
		m.setRoomWalls(2,0,false,true,true,true);	
		m.setRoomItems(2,0,false,false,false,false,false,false,false,false,false,true);		// place goat
		m.setRoomWalls(3,0,true,false,true,false);
		m.setRoomWalls(4,0,false,true,true,true);
		m.setRoomItems(4,0,false,false,false,false,true,false,false,false,false,false); 	// place riddle
		...
		m.setRoomItems(5,1,false,false,false,false,false,false,false,true,false,false);		//place wolf
		// ROW 2
		...
		m.setRoomItems(3,4,false,false,false,false,false,false,false,false,true,false);		// place cabbage
		...
		if (rand % 3 ==0){
		m.setRoomItems(3,4,false,false,true,false,false,false,false,false,false,false); // Place the map in (3,5)
		} else if (rand% 3 ==1){
		m.setRoomItems(2,0,false,false,true,false,false,false,false,false,false,false); // Place the map in (2,0)
		} else { 
		m.setRoomItems(5,5,false,false,true,false,false,false,false,false,false,false); // Place the map in (2,0)
		}
		
		// place door in specific location
		m.setRoomItems(0,5,false,true,false,false,false,false,false,false,false,false);
		m.setDoorLocation(0,5);  // change the door location 
		// place the key in specific location
		m.setRoomItems(5,0,true,false,false,false,false,false,false,false,false,false);
		// place the riddle in a specific location infront of the key (opens wall to get key)
		m.setRoomItems(4,0,false,false,false,false,true,false,false,false,false,false);
