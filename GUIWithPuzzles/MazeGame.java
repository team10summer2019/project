...
///////////////////////////////////////////////////////////////////////////////////////
	...
	public static void setBoard( Maze m){
		...
		//setRoomItems(int x, int y ,boolean key, boolean door ,boolean map, boolean monster, boolean food, boolean riddle, boolean comboLock, boolean hint ){ 
		//ROW 0
		...
		m.setRoomItems(3,0,true,false,false,false,false,false,true,false); // has comboLock
		// room (1,0)
		...
		m.setRoomItems(0,2,false,true,false,false,false,true,false,false);  //has riddle
		// room (1,2)
