...
///////////////////////    MUTATORS     /////////////////////////////////////////////////
	...
	*/
	public void setRoomItems(int x , int y,  boolean key, boolean door ,boolean map, boolean monster, boolean food, boolean riddle, boolean hint, boolean comboLock, boolean goat, boolean wolf, boolean cabbage, boolean farmer){
		if ( x >= 0 && x <= mazeSize-1 && y >=0 && y <= mazeSize-1) {
		Room temp = roomList[x][y];  // get the pointer to the room in list at index k
