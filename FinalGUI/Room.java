...
//////////////////////////   MUTATORS /////////////////////////////////////////////////////
	...
	*/
	...
	public void setHasfarmer(boolean value){
		farmer = value;
		return;
		}
...
//////////////////////////  OTHER METHODS /////////////////////////////////////////////////
	...
	*/
	public void populateRoomGrid(){
		...
		roomGrid[roomCols/2][roomRows/2]='V';
		}else {
...
////////////////// PRIVATE HELPER FUNCTIONS ///////////////////////////////////////
	...
	private void plotItem(int roomWidth){
				...
				System.out.print("F");
				}else if (farmer == true  && k == roomWidth/2){
					System.out.print("V");
